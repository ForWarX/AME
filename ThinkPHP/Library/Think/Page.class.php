...
class Page{
    ...
    public function show() {
		...
		if ($this->config['last']) $this->config['last'] = $this->totalPages;

        //总数
        $header = '<li><span class="rows">' . $this->config['header'] . '</span></li>';
        ...
        $page_str = str_replace(
            ...
            $this->config['theme']);
        return "<nav><ul class='pagination " . $this->config['size'] . "'>{$page_str}</ul></nav>";
    }
}
